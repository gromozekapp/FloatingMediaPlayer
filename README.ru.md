...
- Видео и аудио — автоопределение типа по расширению файла
...
Откройте **`Examples/FMP_EXAMPLE/FMP_EXAMPLE.xcodeproj`** в Xcode и запустите на симуляторе или устройстве.
